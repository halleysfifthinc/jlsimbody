...
void define_simmath_Contact_related(jlcxx::Module& types, const ArrayWrapper& array_wrapper){
  ...
  types.add_bits<SimTK::Contact::Condition>("ContactCondition", jlcxx::julia_type("CppEnum"));
  types.set_const("Contact_Unknown", SimTK::Contact::Unknown);
  types.set_const("Contact_Untracked", SimTK::Contact::Untracked);
  types.set_const("Contact_Anticipated", SimTK::Contact::Anticipated);
  types.set_const("Contact_NewContact", SimTK::Contact::NewContact);
  types.set_const("Contact_Ongoing", SimTK::Contact::Ongoing);
  types.set_const("Contact_Broken", SimTK::Contact::Broken);
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::Contact (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:85:28
  auto contact = types.add_type<SimTK::Contact>("Contact");
  contact.template constructor<>();
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::UntrackedContact (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:182:28
  auto t5 = types.add_type<SimTK::UntrackedContact>("UntrackedContact", contact.dt());
  t5.template constructor<>();
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::BrokenContact (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:216:28
  auto t6 = types.add_type<SimTK::BrokenContact>("BrokenContact", contact.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::CircularPointContact (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:260:28
  auto t7 = types.add_type<SimTK::CircularPointContact>("CircularPointContact", contact.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::EllipticalPointContact (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:355:28
  auto t8 = types.add_type<SimTK::EllipticalPointContact>("EllipticalPointContact", contact.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::BrickHalfSpaceContact (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:418:28
  auto t9 = types.add_type<SimTK::BrickHalfSpaceContact>("BrickHalfSpaceContact", contact.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::TriangleMeshContact (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:478:28
  auto t10 = types.add_type<SimTK::TriangleMeshContact>("TriangleMeshContact", contact.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::PointContact (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:542:28
  auto t11 = types.add_type<SimTK::PointContact>("PointContact", contact.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::ContactGeometry (" __HERE__ ")");
  // defined in simmath/internal/ContactGeometry.h:110:28
  auto contactgeometry = types.add_type<SimTK::ContactGeometry>("ContactGeometry");
  contactgeometry.template constructor<>();
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::ContactGeometry::HalfSpace (" __HERE__ ")");
  // defined in simmath/internal/ContactGeometry.h:826:45
  auto t21 = types.add_type<SimTK::ContactGeometry::HalfSpace>("ContactHalfSpace", contactgeometry.dt());
  ...
  auto t22 = types.add_type<SimTK::ContactGeometry::Cylinder>("ContactCylinder", contactgeometry.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::ContactGeometry::Sphere (" __HERE__ ")");
  // defined in simmath/internal/ContactGeometry.h:895:45
  auto t23 = types.add_type<SimTK::ContactGeometry::Sphere>("ContactSphere", contactgeometry.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::ContactGeometry::Ellipsoid (" __HERE__ ")");
  // defined in simmath/internal/ContactGeometry.h:945:45
  auto t24 = types.add_type<SimTK::ContactGeometry::Ellipsoid>("ContactEllipsoid", contactgeometry.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::ContactGeometry::SmoothHeightMap (" __HERE__ ")");
  // defined in simmath/internal/ContactGeometry.h:1067:18
  auto t25 = types.add_type<SimTK::ContactGeometry::SmoothHeightMap>("ContactSmoothHeightMap", contactgeometry.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::ContactGeometry::Brick (" __HERE__ ")");
  // defined in simmath/internal/ContactGeometry.h:1106:45
  auto t27 = types.add_type<SimTK::ContactGeometry::Brick>("ContactBrick", contactgeometry.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::ContactGeometry::TriangleMesh (" __HERE__ ")");
  // defined in simmath/internal/ContactGeometry.h:1163:45
  auto t28 = types.add_type<SimTK::ContactGeometry::TriangleMesh>("ContactTriangleMesh", contactgeometry.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::ContactGeometry::Torus (" __HERE__ ")");
  // defined in simmath/internal/ContactGeometry.h:1377:45
  auto t32 = types.add_type<SimTK::ContactGeometry::Torus>("ContactTorus", contactgeometry.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::Plane (" __HERE__ ")");
  // defined in simmath/internal/ContactGeometry.h:1414:7
  auto t19 = types.add_type<SimTK::Plane>("Plane");
  t19.template constructor<>();
  CLEAR_DEBUG_MSG();

  auto obbtree = types.add_type<SimTK::OBBTree>("OBBTree");
  auto obbnode = types.add_type<SimTK::OBBNode>("OBBNode");

  DEBUG_MSG("type SimTK::BicubicSurface (" __HERE__ ")");
  // defined in simmath/internal/BicubicSurface.h:158:28
  auto t26 = types.add_type<SimTK::BicubicSurface>("BicubicSurface");
  t26.template constructor<>();
  CLEAR_DEBUG_MSG();

  auto bicubic = types.add_type<SimTK::BicubicFunction>("BicubicFunction", jlcxx::julia_base_type<SimTK::Function_<SimTK::Real>>());
  ...
  auto t30 = types.add_type<SimTK::ContactGeometry::TriangleMesh::OBBTreeNode>("ContactTriangleMesh_OBBTreeNode");
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::OrientedBoundingBox (" __HERE__ ")");
  // defined in simmath/internal/OrientedBoundingBox.h:42:28
  auto t31 = types.add_type<SimTK::OrientedBoundingBox>("OrientedBoundingBox");
  ...
  auto t33 = types.add_type<SimTK::GeodHitPlaneEvent>("GeodHitPlaneEvent");
  t33.template constructor<>();
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::PlaneDecorator (" __HERE__ ")");
  // defined in simmath/internal/ContactGeometry.h:1541:7
  auto t35 = types.add_type<SimTK::PlaneDecorator>("PlaneDecorator", jlcxx::julia_base_type<SimTK::DecorationGenerator>());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::ContactTracker (" __HERE__ ")");
  // defined in simmath/internal/ContactTracker.h:62:28
  auto contacttracker = types.add_type<SimTK::ContactTracker>("ContactTracker");
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::ContactTracker::HalfSpaceSphere (" __HERE__ ")");
  // defined in simmath/internal/ContactTracker.h:181:44
  auto t38 = types.add_type<SimTK::ContactTracker::HalfSpaceSphere>("HalfSpaceSphere_ContactTracker", contacttracker.dt());
  ...
  auto t39 = types.add_type<SimTK::ContactTracker::HalfSpaceEllipsoid>("HalfSpaceEllipsoid_ContactTracker", contacttracker.dt());
  ...
  auto t40 = types.add_type<SimTK::ContactTracker::HalfSpaceBrick>("HalfSpaceBrick_ContactTracker", contacttracker.dt());
  ...
  auto t41 = types.add_type<SimTK::ContactTracker::SphereSphere>("SphereSphere_ContactTracker", contacttracker.dt());
  ...
  auto t42 = types.add_type<SimTK::ContactTracker::HalfSpaceTriangleMesh>("HalfSpaceTriangleMesh_ContactTracker", contacttracker.dt());
  ...
  auto t43 = types.add_type<SimTK::ContactTracker::SphereTriangleMesh>("SphereTriangleMesh_ContactTracker", contacttracker.dt());
  ...
  auto t44 = types.add_type<SimTK::ContactTracker::TriangleMeshTriangleMesh>("TriangleMeshTriangleMesh_ContactTracker", contacttracker.dt());
  ...
  auto t45 = types.add_type<SimTK::ContactTracker::HalfSpaceConvexImplicit>("HalfSpaceConvexImplicit_ContactTracker", contacttracker.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::ContactTracker::ConvexImplicitPair (" __HERE__ ")");
  // defined in simmath/internal/ContactTracker.h:415:44
  auto t46 = types.add_type<SimTK::ContactTracker::ConvexImplicitPair>("ConvexImplicitPair_ContactTracker", contacttracker.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::ContactTracker::GeneralImplicitPair (" __HERE__ ")");
  // defined in simmath/internal/ContactTracker.h:442:44
  auto t47 = types.add_type<SimTK::ContactTracker::GeneralImplicitPair>("GeneralImplicitPair_ContactTracker", contacttracker.dt());
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::ContactMaterial (" __HERE__ ")");
  // defined in simbody/internal/ContactSurface.h:89:28
  auto t49 = types.add_type<SimTK::ContactMaterial>("ContactMaterial");
  t49.template constructor<>();
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("type SimTK::ContactSurface (" __HERE__ ")");
  // defined in simbody/internal/ContactSurface.h:342:28
  auto t50 = types.add_type<SimTK::ContactSurface>("ContactSurface");
  t50.template constructor<>();
  CLEAR_DEBUG_MSG();

  #ifdef JLSIMBODY_USE_SIMTK_UNIQUEINDEX_TYPES
  wrap_SimTK_UniqueIndexType<SimTK::ContactSurfaceIndex>(types, "ContactSurfaceIndex");
  wrap_SimTK_UniqueIndexType<SimTK::ContactId>(types, "ContactId");
  wrap_SimTK_UniqueIndexType<SimTK::ContactTypeId>(types, "ContactTypeId");
  wrap_SimTK_UniqueIndexType<SimTK::ContactGeometryTypeId>(types, "ContactGeometryTypeId");
  wrap_SimTK_UniqueIndexType<SimTK::ContactCliqueId>(types, "ContactCliqueId");
  #endif
  ...
  contact.constructor<const SimTK::Contact &>();
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("SimTK::Contact & SimTK::Contact::operator=(const SimTK::Contact &) (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:112:14
  contact.method("set!", static_cast<SimTK::Contact & (SimTK::Contact::*)(const SimTK::Contact &) >(&SimTK::Contact::operator=));
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("void SimTK::Contact::clear() (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:115:10
  contact.method("clear", static_cast<void (SimTK::Contact::*)() >(&SimTK::Contact::clear));
  CLEAR_DEBUG_MSG();

  // DEBUG_MSG("bool SimTK::Contact::isEmpty() (" __HERE__ ")");
  // // defined in simmath/internal/Contact.h:117:10
  // contact.method("isEmpty", static_cast<bool (SimTK::Contact::*)()  const>(&SimTK::Contact::isEmpty));
  // CLEAR_DEBUG_MSG();

  #ifdef JLSIMBODY_USE_SIMTK_UNIQUEINDEX_TYPES
  DEBUG_MSG("SimTK::ContactId SimTK::Contact::getContactId() (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:122:15
  contact.method("getContactId", static_cast<SimTK::ContactId (SimTK::Contact::*)()  const>(&SimTK::Contact::getContactId));
  CLEAR_DEBUG_MSG();
  #else
  DEBUG_MSG("int SimTK::Contact::getContactId() (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:122:15
  contact.method("getContactId", reinterpret_cast<int (SimTK::Contact::*)()  const>(&SimTK::Contact::getContactId));
  CLEAR_DEBUG_MSG();
  #endif

  DEBUG_MSG("SimTK::Contact::Condition SimTK::Contact::getCondition() (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:124:15
  contact.method("getCondition", static_cast<SimTK::Contact::Condition (SimTK::Contact::*)()  const>(&SimTK::Contact::getCondition));
  CLEAR_DEBUG_MSG();

  #ifdef JLSIMBODY_USE_SIMTK_UNIQUEINDEX_TYPES
  DEBUG_MSG("SimTK::ContactSurfaceIndex SimTK::Contact::getSurface1() (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:127:25
  contact.method("getSurface1", static_cast<SimTK::ContactSurfaceIndex (SimTK::Contact::*)()  const>(&SimTK::Contact::getSurface1));
  CLEAR_DEBUG_MSG();
  #else
  DEBUG_MSG("int SimTK::Contact::getSurface1() (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:127:25
  contact.method("getSurface1", reinterpret_cast<int (SimTK::Contact::*)()  const>(&SimTK::Contact::getSurface1));
  CLEAR_DEBUG_MSG();
  #endif
  ...
  contact.method("getSurface2", static_cast<SimTK::ContactSurfaceIndex (SimTK::Contact::*)()  const>(&SimTK::Contact::getSurface2));
  CLEAR_DEBUG_MSG();
  #else
  DEBUG_MSG("int SimTK::Contact::getSurface2() (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:130:25
  contact.method("getSurface2", reinterpret_cast<int (SimTK::Contact::*)()  const>(&SimTK::Contact::getSurface2));
  CLEAR_DEBUG_MSG();
  #endif

  DEBUG_MSG("const SimTK::Transform & SimTK::Contact::getTransform() (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:134:22
  contact.method("getTransform", static_cast<const SimTK::Transform & (SimTK::Contact::*)()  const>(&SimTK::Contact::getTransform));
  CLEAR_DEBUG_MSG();

  #ifdef JLSIMBODY_USE_SIMTK_UNIQUEINDEX_TYPES
  DEBUG_MSG("SimTK::Contact & SimTK::Contact::setContactId(SimTK::ContactId) (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:138:14
  contact.method("setContactId", static_cast<SimTK::Contact & (SimTK::Contact::*)(SimTK::ContactId) >(&SimTK::Contact::setContactId));
  CLEAR_DEBUG_MSG();
  #else
  DEBUG_MSG("SimTK::Contact & SimTK::Contact::setContactId(int) (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:138:14
  contact.method("setContactId", reinterpret_cast<SimTK::Contact & (SimTK::Contact::*)(int) >(&SimTK::Contact::setContactId));
  CLEAR_DEBUG_MSG();
  #endif
  ...
  contact.method("setCondition", static_cast<SimTK::Contact & (SimTK::Contact::*)(SimTK::Contact::Condition) >(&SimTK::Contact::setCondition));
  CLEAR_DEBUG_MSG();
  ...
  contact.method("setSurfaces", static_cast<SimTK::Contact & (SimTK::Contact::*)(SimTK::ContactSurfaceIndex, SimTK::ContactSurfaceIndex) >(&SimTK::Contact::setSurfaces));
  CLEAR_DEBUG_MSG();
  #else
  DEBUG_MSG("SimTK::Contact & SimTK::Contact::setSurfaces(int, int) (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:142:14
  contact.method("setSurfaces", reinterpret_cast<SimTK::Contact & (SimTK::Contact::*)(int, int) >(&SimTK::Contact::setSurfaces));
  CLEAR_DEBUG_MSG();
  #endif
  ...
  contact.method("setTransform", static_cast<SimTK::Contact & (SimTK::Contact::*)(const SimTK::Transform &) >(&SimTK::Contact::setTransform));
  CLEAR_DEBUG_MSG();

  #ifdef JLSIMBODY_USE_SIMTK_UNIQUEINDEX_TYPES
  DEBUG_MSG("SimTK::ContactTypeId SimTK::Contact::getTypeId() (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:148:19
  contact.method("getTypeId", static_cast<SimTK::ContactTypeId (SimTK::Contact::*)()  const>(&SimTK::Contact::getTypeId));
  CLEAR_DEBUG_MSG();
  #else
  DEBUG_MSG("int SimTK::Contact::getTypeId() (" __HERE__ ")");
  // defined in simmath/internal/Contact.h:148:19
  contact.method("getTypeId", reinterpret_cast<int (SimTK::Contact::*)()  const>(&SimTK::Contact::getTypeId));
  CLEAR_DEBUG_MSG();
  #endif
  ...
  contactgeometry.constructor<const SimTK::ContactGeometry &>();
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("set!", static_cast<SimTK::ContactGeometry & (SimTK::ContactGeometry::*)(const SimTK::ContactGeometry &) >(&SimTK::ContactGeometry::operator=));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("createDecorativeGeometry", static_cast<SimTK::DecorativeGeometry (SimTK::ContactGeometry::*)()  const>(&SimTK::ContactGeometry::createDecorativeGeometry));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("findNearestPoint", static_cast<SimTK::Vec3 (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, bool &, SimTK::UnitVec3 &)  const>(&SimTK::ContactGeometry::findNearestPoint));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("projectDownhillToNearestPoint", static_cast<SimTK::Vec3 (SimTK::ContactGeometry::*)(const SimTK::Vec3 &)  const>(&SimTK::ContactGeometry::projectDownhillToNearestPoint));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("trackSeparationFromLine", static_cast<bool (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::UnitVec3 &, const SimTK::Vec3 &, SimTK::Vec3 &, SimTK::Vec3 &, SimTK::Real &)  const>(&SimTK::ContactGeometry::trackSeparationFromLine));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("intersectsRay", static_cast<bool (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::UnitVec3 &, SimTK::Real &, SimTK::UnitVec3 &)  const>(&SimTK::ContactGeometry::intersectsRay));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("getBoundingSphere", static_cast<void (SimTK::ContactGeometry::*)(SimTK::Vec3 &, SimTK::Real &)  const>(&SimTK::ContactGeometry::getBoundingSphere));
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("bool SimTK::ContactGeometry::isSmooth() (" __HERE__ ")");
  // defined in simmath/internal/ContactGeometry.h:263:6
  contactgeometry.method("isSmooth", static_cast<bool (SimTK::ContactGeometry::*)()  const>(&SimTK::ContactGeometry::isSmooth));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcCurvature", static_cast<void (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, SimTK::Vec2 &, SimTK::Rotation &)  const>(&SimTK::ContactGeometry::calcCurvature));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("getImplicitFunction", static_cast<const SimTK::Function & (SimTK::ContactGeometry::*)()  const>(&SimTK::ContactGeometry::getImplicitFunction));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcSurfaceValue", static_cast<SimTK::Real (SimTK::ContactGeometry::*)(const SimTK::Vec3 &)  const>(&SimTK::ContactGeometry::calcSurfaceValue));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcSurfaceUnitNormal", static_cast<SimTK::UnitVec3 (SimTK::ContactGeometry::*)(const SimTK::Vec3 &)  const>(&SimTK::ContactGeometry::calcSurfaceUnitNormal));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcSurfaceGradient", static_cast<SimTK::Vec3 (SimTK::ContactGeometry::*)(const SimTK::Vec3 &)  const>(&SimTK::ContactGeometry::calcSurfaceGradient));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcSurfaceHessian", static_cast<SimTK::Mat33 (SimTK::ContactGeometry::*)(const SimTK::Vec3 &)  const>(&SimTK::ContactGeometry::calcSurfaceHessian));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcGaussianCurvature", static_cast<SimTK::Real (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::Mat33 &)  const>(&SimTK::ContactGeometry::calcGaussianCurvature));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcGaussianCurvature", static_cast<SimTK::Real (SimTK::ContactGeometry::*)(const SimTK::Vec3 &)  const>(&SimTK::ContactGeometry::calcGaussianCurvature));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcSurfaceCurvatureInDirection", static_cast<SimTK::Real (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::UnitVec3 &)  const>(&SimTK::ContactGeometry::calcSurfaceCurvatureInDirection));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcSurfacePrincipalCurvatures", static_cast<void (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, SimTK::Vec2 &, SimTK::Rotation &)  const>(&SimTK::ContactGeometry::calcSurfacePrincipalCurvatures));
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("bool SimTK::ContactGeometry::isConvex() (" __HERE__ ")");
  // defined in simmath/internal/ContactGeometry.h:391:6
  contactgeometry.method("isConvex", static_cast<bool (SimTK::ContactGeometry::*)()  const>(&SimTK::ContactGeometry::isConvex));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcSupportPoint", static_cast<SimTK::Vec3 (SimTK::ContactGeometry::*)(SimTK::UnitVec3)  const>(&SimTK::ContactGeometry::calcSupportPoint));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("getTypeId", static_cast<SimTK::ContactGeometryTypeId (SimTK::ContactGeometry::*)()  const>(&SimTK::ContactGeometry::getTypeId));
  CLEAR_DEBUG_MSG();
  #else
  DEBUG_MSG("int SimTK::ContactGeometry::getTypeId() (" __HERE__ ")");
  // defined in simmath/internal/ContactGeometry.h:402:23
  contactgeometry.method("getTypeId", reinterpret_cast<int (SimTK::ContactGeometry::*)()  const>(&SimTK::ContactGeometry::getTypeId));
  CLEAR_DEBUG_MSG();
  #endif
  ...
  contactgeometry.method("initGeodesic", static_cast<void (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::Vec3 &, const SimTK::Vec3 &, const SimTK::GeodesicOptions &, SimTK::Geodesic &)  const>(&SimTK::ContactGeometry::initGeodesic));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("continueGeodesic", static_cast<void (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::Vec3 &, const SimTK::Geodesic &, const SimTK::GeodesicOptions &, SimTK::Geodesic &)  const>(&SimTK::ContactGeometry::continueGeodesic));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("makeStraightLineGeodesic", static_cast<void (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::Vec3 &, const SimTK::UnitVec3 &, const SimTK::GeodesicOptions &, SimTK::Geodesic &)  const>(&SimTK::ContactGeometry::makeStraightLineGeodesic));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("shootGeodesicInDirectionUntilLengthReached", static_cast<void (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::UnitVec3 &, const SimTK::Real &, const SimTK::GeodesicOptions &, SimTK::Geodesic &)  const>(&SimTK::ContactGeometry::shootGeodesicInDirectionUntilLengthReached));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcGeodesicReverseSensitivity", static_cast<void (SimTK::ContactGeometry::*)(SimTK::Geodesic &, const SimTK::Vec2 &)  const>(&SimTK::ContactGeometry::calcGeodesicReverseSensitivity));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("shootGeodesicInDirectionUntilPlaneHit", static_cast<void (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::UnitVec3 &, const SimTK::Plane &, const SimTK::GeodesicOptions &, SimTK::Geodesic &)  const>(&SimTK::ContactGeometry::shootGeodesicInDirectionUntilPlaneHit));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcGeodesic", static_cast<void (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::Vec3 &, const SimTK::Vec3 &, const SimTK::Vec3 &, SimTK::Geodesic &)  const>(&SimTK::ContactGeometry::calcGeodesic));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcGeodesicUsingOrthogonalMethod", static_cast<void (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::Vec3 &, const SimTK::Vec3 &, SimTK::Real, SimTK::Geodesic &)  const>(&SimTK::ContactGeometry::calcGeodesicUsingOrthogonalMethod));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcGeodesicUsingOrthogonalMethod", static_cast<void (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::Vec3 &, SimTK::Geodesic &)  const>(&SimTK::ContactGeometry::calcGeodesicUsingOrthogonalMethod));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcSplitGeodError", static_cast<SimTK::Vec2 (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::Vec3 &, const SimTK::UnitVec3 &, const SimTK::UnitVec3 &, SimTK::Geodesic *)  const>(&SimTK::ContactGeometry::calcSplitGeodError));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("shootGeodesicInDirectionUntilLengthReachedAnalytical", static_cast<void (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::UnitVec3 &, const SimTK::Real &, const SimTK::GeodesicOptions &, SimTK::Geodesic &)  const>(&SimTK::ContactGeometry::shootGeodesicInDirectionUntilLengthReachedAnalytical));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("shootGeodesicInDirectionUntilPlaneHitAnalytical", static_cast<void (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::UnitVec3 &, const SimTK::Plane &, const SimTK::GeodesicOptions &, SimTK::Geodesic &)  const>(&SimTK::ContactGeometry::shootGeodesicInDirectionUntilPlaneHitAnalytical));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcGeodesicAnalytical", static_cast<void (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::Vec3 &, const SimTK::Vec3 &, const SimTK::Vec3 &, SimTK::Geodesic &)  const>(&SimTK::ContactGeometry::calcGeodesicAnalytical));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("calcSplitGeodErrorAnalytical", static_cast<SimTK::Vec2 (SimTK::ContactGeometry::*)(const SimTK::Vec3 &, const SimTK::Vec3 &, const SimTK::UnitVec3 &, const SimTK::UnitVec3 &, SimTK::Geodesic *)  const>(&SimTK::ContactGeometry::calcSplitGeodErrorAnalytical));
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("const SimTK::Plane & SimTK::ContactGeometry::getPlane() (" __HERE__ ")");
  // defined in simmath/internal/ContactGeometry.h:791:14
  contactgeometry.method("getPlane", static_cast<const SimTK::Plane & (SimTK::ContactGeometry::*)()  const>(&SimTK::ContactGeometry::getPlane));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("setPlane", static_cast<void (SimTK::ContactGeometry::*)(const SimTK::Plane &)  const>(&SimTK::ContactGeometry::setPlane));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("getGeodP", static_cast<const SimTK::Geodesic & (SimTK::ContactGeometry::*)()  const>(&SimTK::ContactGeometry::getGeodP));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("getGeodQ", static_cast<const SimTK::Geodesic & (SimTK::ContactGeometry::*)()  const>(&SimTK::ContactGeometry::getGeodQ));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("getNumGeodesicsShot", static_cast<const int (SimTK::ContactGeometry::*)()  const>(&SimTK::ContactGeometry::getNumGeodesicsShot));
  CLEAR_DEBUG_MSG();
  ...
  contactgeometry.method("addVizReporter", static_cast<void (SimTK::ContactGeometry::*)(SimTK::ScheduledEventReporter *)  const>(&SimTK::ContactGeometry::addVizReporter));
  CLEAR_DEBUG_MSG();
  ...
  types.method("evalParametricCurvature", static_cast<SimTK::Vec2 (*)(const SimTK::Vec3 &, const SimTK::UnitVec3 &, const SimTK::Vec3 &, const SimTK::Vec3 &, const SimTK::Vec3 &, const SimTK::Vec3 &, const SimTK::Vec3 &, SimTK::Transform &) >(&SimTK::ContactGeometry::evalParametricCurvature));
  CLEAR_DEBUG_MSG();
  ...
  types.method("combineParaboloids", static_cast<void (*)(const SimTK::Rotation &, const SimTK::Vec2 &, const SimTK::UnitVec3 &, const SimTK::Vec2 &, SimTK::Rotation &, SimTK::Vec2 &) >(&SimTK::ContactGeometry::combineParaboloids));
  CLEAR_DEBUG_MSG();
  ...
  types.method("combineParaboloids", static_cast<void (*)(const SimTK::Rotation &, const SimTK::Vec2 &, const SimTK::UnitVec3 &, const SimTK::Vec2 &, SimTK::Vec2 &) >(&SimTK::ContactGeometry::combineParaboloids));
  CLEAR_DEBUG_MSG();
  ...
  DEBUG_MSG("void SimTK::BicubicFunction::BicubicFunction(const SimTK::BicubicSurface&) (" __HERE__ ")");
  bicubic.template constructor<const SimTK::BicubicSurface&>();
  CLEAR_DEBUG_MSG();

  bicubic.method("getBicubicSurface", static_cast<const SimTK::BicubicSurface & (SimTK::BicubicFunction::*)() const>(&SimTK::BicubicFunction::getBicubicSurface));

  DEBUG_MSG("SimTK::Real SimTK::BicubicFunction::calcValue(const SimTK::Vector &) (" __HERE__ ")");
  bicubic.method("calcValue", static_cast<SimTK::Real (SimTK::BicubicFunction::*)(const SimTK::Vector &)  const>(&SimTK::BicubicFunction::calcValue));
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("SimTK::Real SimTK::BicubicFunction::calcDerivative(const SimTK::Array_<int> &, const SimTK::Vector &) (" __HERE__ ")");
  bicubic.method("calcDerivative", static_cast<SimTK::Real (SimTK::BicubicFunction::*)(const SimTK::Array_<int> &, const SimTK::Vector &)  const>(&SimTK::BicubicFunction::calcDerivative));
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("int SimTK::BicubicFunction::getArgumentSize() (" __HERE__ ")");
  bicubic.method("getArgumentSize", static_cast<int (SimTK::BicubicFunction::*)()  const>(&SimTK::BicubicFunction::getArgumentSize));
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("int SimTK::BicubicFunction::getMaxDerivativeOrder() (" __HERE__ ")");
  bicubic.method("getMaxDerivativeOrder", static_cast<int (SimTK::BicubicFunction::*)()  const>(&SimTK::BicubicFunction::getMaxDerivativeOrder));
  CLEAR_DEBUG_MSG();

  DEBUG_MSG("SimTK::BicubicFunction * SimTK::BicubicFunction::clone() (" __HERE__ ")");
  bicubic.method("clone", reinterpret_cast<SimTK::BicubicFunction * (SimTK::BicubicFunction::*)()  const>(&SimTK::BicubicFunction::clone));
  CLEAR_DEBUG_MSG();

  obbtree.method("getRoot", static_cast<const SimTK::OBBNode & (SimTK::OBBTree::*)() const>(&SimTK::OBBTree::getRoot));
  obbtree.method("updRoot", static_cast<SimTK::OBBNode & (SimTK::OBBTree::*)() >(&SimTK::OBBTree::updRoot));

  // Potential TODO: Add accessor methods for public fields
  obbnode.constructor<>();
  obbnode.method("clear", static_cast<void (SimTK::OBBNode::*)() >(&SimTK::OBBNode::clear));
  obbnode.method("isLeaf", static_cast<bool (SimTK::OBBNode::*)() const>(&SimTK::OBBNode::isLeaf));
  obbnode.method("getNumChildren", static_cast<int (SimTK::OBBNode::*)() const>(&SimTK::OBBNode::getNumChildren));
  obbnode.method("getChild", static_cast<const SimTK::OBBNode & (SimTK::OBBNode::*)(int) const>(&SimTK::OBBNode::getChild));
  obbnode.method("updChild", static_cast<SimTK::OBBNode & (SimTK::OBBNode::*)(int) >(&SimTK::OBBNode::updChild));
  ...
  t28.constructor<const SimTK::Array_<SimTK::Vec3> &, const SimTK::Array_<int> &, bool>(
    jlcxx::arg("vertices"), jlcxx::arg("faceIndices"), jlcxx::arg("smooth")=false
  );
  CLEAR_DEBUG_MSG();
  ...
  t28.constructor<const SimTK::PolygonalMesh &, bool>(
    jlcxx::arg("mesh"), jlcxx::arg("smooth")=false
  );
  CLEAR_DEBUG_MSG();
  ...
  // contacttracker.method("getContactGeometryTypeIds", static_cast<const std::pair<SimTK::ContactGeometryTypeId,SimTK::ContactGeometryTypeId> & (SimTK::ContactTracker::*)()  const>(&SimTK::ContactTracker::getContactGeometryTypeIds));
  #else
  ...
  contacttracker.method("trackContact", static_cast<bool (SimTK::ContactTracker::*)(const SimTK::Contact &, const SimTK::Transform &, const SimTK::ContactGeometry &, const SimTK::Transform &, const SimTK::ContactGeometry &, SimTK::Real, SimTK::Contact &)  const>(&SimTK::ContactTracker::trackContact));
  CLEAR_DEBUG_MSG();
  ...
  types.method("refineImplicitPair", static_cast<bool (*)(const SimTK::ContactGeometry &, SimTK::Vec3 &, const SimTK::ContactGeometry &, SimTK::Vec3 &, const SimTK::Transform &, SimTK::Real, SimTK::Real &, int &) >(&SimTK::ContactTracker::refineImplicitPair));
  CLEAR_DEBUG_MSG();
  ...
  types.method("findImplicitPairError", static_cast<SimTK::Vec6 (*)(const SimTK::ContactGeometry &, const SimTK::Vec3 &, const SimTK::ContactGeometry &, const SimTK::Vec3 &, const SimTK::Transform &) >(&SimTK::ContactTracker::findImplicitPairError));
  CLEAR_DEBUG_MSG();
  ...
  types.method("calcImplicitPairJacobian", static_cast<SimTK::Mat66 (*)(const SimTK::ContactGeometry &, const SimTK::Vec3 &, const SimTK::ContactGeometry &, const SimTK::Vec3 &, const SimTK::Transform &, const SimTK::Vec6 &) >(&SimTK::ContactTracker::calcImplicitPairJacobian));
  CLEAR_DEBUG_MSG();
  ...
  types.method("estimateConvexImplicitPairContactUsingMPR", static_cast<bool (*)(const SimTK::ContactGeometry &, const SimTK::ContactGeometry &, const SimTK::Transform &, SimTK::Vec3 &, SimTK::Vec3 &, SimTK::UnitVec3 &, int &) >(&SimTK::ContactTracker::estimateConvexImplicitPairContactUsingMPR));
  CLEAR_DEBUG_MSG();
  ...
  t49.constructor<SimTK::Real, SimTK::Real, SimTK::Real, SimTK::Real, SimTK::Real>(
     jlcxx::arg("stiffness"), jlcxx::arg("dissipation"), jlcxx::arg("staticFriction"), jlcxx::arg("dynamicFriction"), jlcxx::arg("viscousFriction")=0
  );
  CLEAR_DEBUG_MSG();
  ...
  types.method("calcPlaneStrainStiffness", static_cast<SimTK::Real (*)(SimTK::Real, SimTK::Real) >(&SimTK::ContactMaterial::calcPlaneStrainStiffness));
  CLEAR_DEBUG_MSG();
  ...
  types.method("calcConfinedCompressionStiffness", static_cast<SimTK::Real (*)(SimTK::Real, SimTK::Real) >(&SimTK::ContactMaterial::calcConfinedCompressionStiffness));
  CLEAR_DEBUG_MSG();
  ...
  types.method("calcDissipationFromObservedRestitution", static_cast<SimTK::Real (*)(SimTK::Real, SimTK::Real) >(&SimTK::ContactMaterial::calcDissipationFromObservedRestitution));
  CLEAR_DEBUG_MSG();
  ...
  t50.constructor<const SimTK::ContactGeometry &, const SimTK::ContactMaterial &, SimTK::Real>(
    jlcxx::arg("shape"), jlcxx::arg("material"), jlcxx::arg("thickness")=0
  );
  CLEAR_DEBUG_MSG();
  ...
  t50.method("getCliques", [] (const SimTK::ContactSurface& self) -> const SimTK::Array_<int>* {
    auto cliques = self.getCliques();
    auto arr = new SimTK::Array_<int>(cliques.size());
    *arr = cliques;
    return arr;
  });
