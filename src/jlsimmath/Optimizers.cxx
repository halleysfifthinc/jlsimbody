...
void define_simmath_Optimizers(jlcxx::Module& module) {
  ...
  // signature to use in the veto list: void SimTK::Optimizer::setConvergenceTolerance(SimTK::Real)
  ...
  // signature to use in the veto list: void SimTK::Optimizer::setConstraintTolerance(SimTK::Real)
  ...
  // signature to use in the veto list: void SimTK::Optimizer::setMaxIterations(int)
  ...
  // signature to use in the veto list: void SimTK::Optimizer::setLimitedMemoryHistory(int)
  ...
  // signature to use in the veto list: void SimTK::Optimizer::setDiagnosticsLevel(int)
  ...
  // signature to use in the veto list: void SimTK::Optimizer::setOptimizerSystem(const SimTK::OptimizerSystem &)
  ...
  // signature to use in the veto list: void SimTK::Optimizer::setOptimizerSystem(const SimTK::OptimizerSystem &, SimTK::OptimizerAlgorithm)
  ...
  // signature to use in the veto list: bool SimTK::Optimizer::setAdvancedStrOption(const char *, const char *)
  ...
  // signature to use in the veto list: bool SimTK::Optimizer::setAdvancedRealOption(const char *, const SimTK::Real)
  ...
  // signature to use in the veto list: bool SimTK::Optimizer::setAdvancedIntOption(const char *, const int)
  ...
  // signature to use in the veto list: bool SimTK::Optimizer::setAdvancedBoolOption(const char *, const bool)
  ...
  // signature to use in the veto list: bool SimTK::Optimizer::setAdvancedVectorOption(const char *, const SimTK::Vector)
  ...
  // signature to use in the veto list: void SimTK::Optimizer::setDifferentiatorMethod(SimTK::Differentiator::Method)
  ...
  // signature to use in the veto list: SimTK::Differentiator::Method SimTK::Optimizer::getDifferentiatorMethod()
  ...
  // signature to use in the veto list: SimTK::OptimizerAlgorithm SimTK::Optimizer::getAlgorithm()
  ...
  // signature to use in the veto list: void SimTK::Optimizer::useNumericalGradient(bool, SimTK::Real)
  ...
  // signature to use in the veto list: void SimTK::Optimizer::useNumericalJacobian(bool, SimTK::Real)
  ...
  // signature to use in the veto list: SimTK::Real SimTK::Optimizer::optimize(SimTK::Vector &)
  ...
  // signature to use in the veto list: const SimTK::OptimizerSystem & SimTK::Optimizer::getOptimizerSystem()
  ...
  // signature to use in the veto list: bool SimTK::Optimizer::isUsingNumericalGradient()
  ...
  // signature to use in the veto list: bool SimTK::Optimizer::isUsingNumericalJacobian()
  ...
  // signature to use in the veto list: SimTK::Real SimTK::Optimizer::getEstimatedAccuracyOfObjective()
  ...
  // signature to use in the veto list: SimTK::Real SimTK::Optimizer::getEstimatedAccuracyOfConstraints()
  ...
  // signature to use in the veto list: int SimTK::OptimizerSystem::objectiveFunc(const SimTK::Vector &, bool, SimTK::Real &)
  ...
  // signature to use in the veto list: int SimTK::OptimizerSystem::gradientFunc(const SimTK::Vector &, bool, SimTK::Vector &)
  ...
  // signature to use in the veto list: int SimTK::OptimizerSystem::constraintFunc(const SimTK::Vector &, bool, SimTK::Vector &)
  ...
  // signature to use in the veto list: int SimTK::OptimizerSystem::constraintJacobian(const SimTK::Vector &, bool, SimTK::Matrix &)
  ...
  // signature to use in the veto list: int SimTK::OptimizerSystem::hessian(const SimTK::Vector &, bool, SimTK::Vector &)
  ...
  // signature to use in the veto list: void SimTK::OptimizerSystem::setNumParameters(const int)
  ...
  // signature to use in the veto list: void SimTK::OptimizerSystem::setNumEqualityConstraints(const int)
  ...
  // signature to use in the veto list: void SimTK::OptimizerSystem::setNumInequalityConstraints(const int)
  ...
  // signature to use in the veto list: void SimTK::OptimizerSystem::setNumLinearEqualityConstraints(const int)
  ...
  // signature to use in the veto list: void SimTK::OptimizerSystem::setNumLinearInequalityConstraints(const int)
  ...
  // signature to use in the veto list: void SimTK::OptimizerSystem::setParameterLimits(const SimTK::Vector &, const SimTK::Vector &)
  ...
  // signature to use in the veto list: int SimTK::OptimizerSystem::getNumParameters()
  ...
  // signature to use in the veto list: int SimTK::OptimizerSystem::getNumConstraints()
  ...
  // signature to use in the veto list: int SimTK::OptimizerSystem::getNumEqualityConstraints()
  ...
  // signature to use in the veto list: int SimTK::OptimizerSystem::getNumInequalityConstraints()
  ...
  // signature to use in the veto list: int SimTK::OptimizerSystem::getNumLinearEqualityConstraints()
  ...
  // signature to use in the veto list: int SimTK::OptimizerSystem::getNumNonlinearEqualityConstraints()
  ...
  // signature to use in the veto list: int SimTK::OptimizerSystem::getNumLinearInequalityConstraints()
  ...
  // signature to use in the veto list: int SimTK::OptimizerSystem::getNumNonlinearInequalityConstraints()
  ...
  // signature to use in the veto list: bool SimTK::OptimizerSystem::getHasLimits()
  ...
  // signature to use in the veto list: void SimTK::OptimizerSystem::getParameterLimits(SimTK::Real **, SimTK::Real **)
