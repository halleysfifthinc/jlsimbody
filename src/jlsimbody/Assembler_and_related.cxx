...
void define_simbody_Assembler_and_related(jlcxx::Module& types, const ArrayWrapper& array_wrapper){
  ...
  DEBUG_MSG("void SimTK::Markers::defineObservationOrder(int, const char *const[]) (" __HERE__ ")");
  ...
  DEBUG_MSG("void SimTK::OrientationSensors::defineObservationOrder(int, const char *const[]) (" __HERE__ ")");
