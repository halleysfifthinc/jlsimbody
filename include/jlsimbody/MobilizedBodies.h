...
namespace jlcxx {
  ...
  template<> struct SuperType<SimTK::MobilizedBody::Ground> { typedef SimTK::MobilizedBody type; };
...
namespace jlsimbody {
  JLSIMBODY_NO_EXPORT void define_simbody_MobilizedBodies(jlcxx::Module& types, const ArrayWrapper & array_wrapper);
}
