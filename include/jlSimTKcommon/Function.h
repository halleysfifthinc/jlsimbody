...
namespace jlcxx {
  ...
  template<typename T> struct SuperType<SimTK::Function_Constant_<T>> { using type = SimTK::Function_<T>; };
  template<typename T> struct SuperType<SimTK::Function_Linear_<T>> { using type = SimTK::Function_<T>; };
  template<typename T> struct SuperType<SimTK::Function_Polynomial_<T>> { using type = SimTK::Function_<T>; };
  template<typename T> struct SuperType<SimTK::Function_Sinusoid_<T>> { using type = SimTK::Function_<T>; };
  template<typename T> struct SuperType<SimTK::Function_Step_<T>> { using type = SimTK::Function_<T>; };
  template<typename T> struct SuperType<SimTK::Spline_<T>> { using type = SimTK::Function_<T>; };
}
